...
# Modify WiFi SSID
#sed -i 's/set wireless.default_radio\${devidx}.ssid=OpenWrt/set wireless.default_radio\${devidx}.ssid=WIFI-SSID/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh

# Forced to enable WIFI
